      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h4 className="text-2xl font-bold mb-2">
            Ride More. Spend Less. Stay Eco-Friendly.
          </h4>
          <p className="text-sm md:text-base font-medium">
            No petrol • No noise • No stress • Just smooth electric rides
          </p>
        </motion.div>
      </div>
    </section>
...
const steps = [
  {
    ...
    description:
      "Plug in your electric bike at night using a normal household power socket.",
    image: "/image(5).jpg",
  },
  {
    title: "Ride Daily",
    description:
      "Enjoy smooth, silent rides with zero fuel cost and ultra-low maintenance.",
    image: "/images(8).jpg",
  },
  {
    title: "Save Every Month",
    description:
      "Cut petrol expenses and service costs while protecting the environment.",
    image: "/image(7).jpg",
  },
];
